  ...
  render() {
    ...
    return (
      <React.Fragment>
        ...
        <Button
          onClick={() => this.props.history.push("/step/first")}
          type="primary"
        >
          {i18n.t("add")}
        </Button>
        ...
        <Button
          onClick={() => this.props.history.push("/inlineComponentPage")}
          type="primary"
        >
          {i18n.t("inline-component")}
        </Button>
...
const TestForm = () => {
  ...
  //   console.log(setSurname)
  //   console.log(name + '*****' + surname)
  // },[surname]);
  // return <button onClick={() => setName('aaaaa')}>{name}</button>
